...
class Simulation(object):
    ...
    current_infected: Int.  The number of current people in the population currently
    ...
    def _create_population(self, initial_infected):
        ...
        while len(population) != pop_size:
            if infected_count != initial_infected:
                ...
                # new infected person!
                infected_person = Person(next_person_id, False, True)
            else:
                ...
                vaccination_decider = random.randint(0, 1)
                if vaccination_decider < vacc_percentage:
                    new_person = Person(next_person_id, True, False)
    ...
    def _simulation_should_continue(self):
        ...
        if population_size == 0:
            print("Entire population has been wiped out by {}".format(self.virus_name))
            self.end = True
        elif total_infected == 0:
            print("Thank heavens, the virus population has died out...")
            self.end = True
